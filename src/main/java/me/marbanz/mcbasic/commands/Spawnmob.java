                ...
                if (sender.hasPermission("mcbasic.spawnmob")) {
                    if (args.length == 1){
                        ...
                        if(args[0].equalsIgnoreCase("Wolf")){
                            ...
                            p.sendMessage("§aSpawned Spider1");
                            ...
                            p.sendMessage("§aSpawned Elder Guardian1");
                            ...
                            p.sendMessage("§aSpawned Zombie Horse1");
